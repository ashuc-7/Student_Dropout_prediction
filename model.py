...
#Loading all the saved label encodings of categories
...
def predict(data): #Function to predict the ouput
    clf = joblib.load('model.pkl','rb')#Loading the saved model
...
data=np.asarray([data]) #Converting the list into array
